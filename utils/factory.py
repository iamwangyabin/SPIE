def get_model(model_name, args):
    ...
    if name == "tuna":
        ...
        raise ValueError("Supported model names are 'tuna', 'tunamax', 'spie_v2', 'spie_v3', 'spie_v4', 'spie_v5', 'spie_v6', 'spie_v7', 'spie_v8', 'spie_v9', 'spie_v10', 'spie_v11', 'spie', and 'onlymax'.")
    return Learner(args)
