...
def get_backbone(args, pretrained=False):
    ...
    # Coda_Prompt
        ...
        if name == "vit_base_patch16_224_spie_v2":
            ...
            raise NotImplementedError("Unknown type {}".format(name))
        return model
    elif "_spie_v3" in name:
        ffn_num = 16
        from backbone import vit_spie_v3
        from easydict import EasyDict
        tuning_config = EasyDict(
            ffn_adapt=True,
            ffn_option="parallel",
        ...
        if name == "vit_base_patch16_224_spie_v3":
            model = vit_spie_v3.vit_base_patch16_224_spie_v3(
                num_classes=args["nb_classes"],
                global_pool=False,
                drop_path_rate=0.0,
                tuning_config=tuning_config,
            ...
            raise NotImplementedError("Unknown type {}".format(name))
        return model
    elif "_spie_v4" in name:
        ffn_num = 16
        from backbone import vit_spie_v4
        from easydict import EasyDict
        tuning_config = EasyDict(
            ffn_adapt=True,
            ffn_option="parallel",
        ...
        if name == "vit_base_patch16_224_spie_v4":
            model = vit_spie_v4.vit_base_patch16_224_spie_v4(
                num_classes=args["nb_classes"],
                global_pool=False,
                drop_path_rate=0.0,
                tuning_config=tuning_config,
        ...
        elif name == "vit_base_patch16_224_in21k_spie_v4":
            model = vit_spie_v4.vit_base_patch16_224_in21k_spie_v4(
                num_classes=args["nb_classes"],
                global_pool=False,
                drop_path_rate=0.0,
                tuning_config=tuning_config,
            ...
            raise NotImplementedError("Unknown type {}".format(name))
        return model
    elif "_spie_v5" in name or "_spiev5" in name:
        ffn_num = 16
        from backbone import vit_spie_v5
        from easydict import EasyDict
        tuning_config = EasyDict(
            ffn_adapt=True,
            ffn_option="parallel",
        ...
        if name == "vit_base_patch16_224_spie_v5" or name == "vit_base_patch16_224_spiev5":
            model = vit_spie_v5.vit_base_patch16_224_spie_v5(
                num_classes=args["nb_classes"],
                global_pool=False,
                drop_path_rate=0.0,
                tuning_config=tuning_config,
        ...
        elif name == "vit_base_patch16_224_in21k_spie_v5" or name == "vit_base_patch16_224_in21k_spiev5":
            model = vit_spie_v5.vit_base_patch16_224_in21k_spie_v5(
                num_classes=args["nb_classes"],
                global_pool=False,
                drop_path_rate=0.0,
                tuning_config=tuning_config,
            ...
            raise NotImplementedError("Unknown type {}".format(name))
        return model
    elif "_spie_v6" in name or "_spiev6" in name:
        ffn_num = 16
        from backbone import vit_spie_v6
        from easydict import EasyDict
        tuning_config = EasyDict(
            ffn_adapt=True,
            ffn_option="parallel",
        ...
        if name == "vit_base_patch16_224_spie_v6" or name == "vit_base_patch16_224_spiev6":
            model = vit_spie_v6.vit_base_patch16_224_spie_v6(**common_kwargs)
        elif name == "vit_base_patch16_224_in21k_spie_v6" or name == "vit_base_patch16_224_in21k_spiev6":
            model = vit_spie_v6.vit_base_patch16_224_in21k_spie_v6(**common_kwargs)
        else:
            raise NotImplementedError("Unknown type {}".format(name))
        return model
        ...
        if name == "vit_base_patch16_224_spie_v7" or name == "vit_base_patch16_224_spiev7":
            ...
            raise NotImplementedError("Unknown type {}".format(name))
        return model
    elif "_spie_v8" in name or "_spiev8" in name:
        ffn_num = 16
        from backbone import vit_spie_v8
        from easydict import EasyDict
        tuning_config = EasyDict(
            ffn_adapt=True,
            ffn_option="parallel",
        ...
        if name == "vit_base_patch16_224_spie_v8" or name == "vit_base_patch16_224_spiev8":
            model = vit_spie_v8.vit_base_patch16_224_spie_v8(**common_kwargs)
        elif name == "vit_base_patch16_224_in21k_spie_v8" or name == "vit_base_patch16_224_in21k_spiev8":
            model = vit_spie_v8.vit_base_patch16_224_in21k_spie_v8(**common_kwargs)
        else:
            raise NotImplementedError("Unknown type {}".format(name))
        return model
    elif "_spie_v10" in name or "_spiev10" in name:
        ffn_num = 16
        from backbone import vit_spie_v10
        from easydict import EasyDict
        tuning_config = EasyDict(
            ffn_adapt=True,
            ffn_option="parallel",
        ...
        if name == "vit_base_patch16_224_spie_v10" or name == "vit_base_patch16_224_spiev10":
            model = vit_spie_v10.vit_base_patch16_224_spie_v10(**common_kwargs)
        elif name == "vit_base_patch16_224_in21k_spie_v10" or name == "vit_base_patch16_224_in21k_spiev10":
            model = vit_spie_v10.vit_base_patch16_224_in21k_spie_v10(**common_kwargs)
        else:
            raise NotImplementedError("Unknown type {}".format(name))
        return model
        ...
        if name == "vit_base_patch16_224_spie_v11" or name == "vit_base_patch16_224_spiev11":
            model = vit_spie_v11.vit_base_patch16_224_spie_v11(**common_kwargs)
        elif name == "vit_base_patch16_224_in21k_spie_v11" or name == "vit_base_patch16_224_in21k_spiev11":
            model = vit_spie_v11.vit_base_patch16_224_in21k_spie_v11(**common_kwargs)
        else:
            raise NotImplementedError("Unknown type {}".format(name))
        return model
