...
from backbone.vit_min_ablation import VisionTransformer
...
def get_min_ablation_backbone(args):
...
class MiNAblationNet(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.args = args
        self.device = args["device"][0]
        self.backbone = get_min_ablation_backbone(args)
