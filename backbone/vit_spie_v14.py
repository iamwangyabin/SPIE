...
class VisionTransformer(TunaMaxVisionTransformer):
    """SPiE v14 ViT with shared LoRA and parallel multi-expert inference."""
...
def vit_base_patch16_224_spie_v14(pretrained=False, **kwargs):
    del pretrained
...
def vit_base_patch16_224_in21k_spie_v14(pretrained=False, **kwargs):
    del pretrained
    model = VisionTransformer(
        patch_size=16,
        embed_dim=768,
