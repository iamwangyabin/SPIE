...
class VisionTransformer(nn.Module):
    """Vision Transformer used by tunamax."""
    ...
    def __init__(self, global_pool=False, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768,
        ...
        print("I'm using ViT with tunamax adapters.")
        ...
        self.down_weight_sum = [[] for i in range(len(self.blocks))]
...
def vit_base_patch16_224_tunamax(pretrained=False, **kwargs):
...
def vit_base_patch16_224_in21k_tunamax(pretrained=False, **kwargs):
    model = VisionTransformer(patch_size=16, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4, qkv_bias=True,
                              norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
